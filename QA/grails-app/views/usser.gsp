...
<head>
 ...
 <div class="form-group">
   ...
   <div class="col-md-8">
      <g:textField name="userName" disabled="true" value="${user.userName}" onfocus="clearContents(this);" class="form-control input-lg"/>
    </div>	
  </div>                    
  <div class="form-group">
    <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-pencil-square-o bigicon"></i></span>
    <div class="col-md-8">
      <g:textArea name="nbrQ" disabled="true" value="${user.bio}" rows="10" onfocus="clearContents(this);" class="form-control input-lg"/>
     </div>
 </div>
 </div>
