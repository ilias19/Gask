    ...
    <div class="row">
        <div class="col-md-12">
            <div class="well well-sm">
                <g:form class="form-horizontal" onkeypress="stopEnterSubmitting(window.event)" controller="user">
                    <fieldset>
                        <legend class="text-center header">Profile</legend>

                       <div class="form-group">
                           <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                           <div class="col-md-8">
              				<g:textField name="userName" value="${session.getAttribute("user").userName}" onfocus="clearContents(this);" class="form-control input-lg"/>
              			   </div>	
            		   </div>                    
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-pencil-square-o bigicon"></i></span>
                            <div class="col-md-8">
                                <g:textArea name="biographie" value="${session.getAttribute("user").bio}" rows="10" onfocus="clearContents(this);"  class="form-control input-lg"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-pencil-square-o bigicon"></i></span>
                            <div class="col-md-8">
                                <g:textField name="website" value="${session.getAttribute("user").website}" rows="10" onfocus="clearContents(this);"  class="form-control input-lg"/>
                            </div>
                        </div>
                         <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-pencil-square-o bigicon"></i></span>
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <g:actionSubmit value="Update" action="update" class="btn btn-primary btn-lg"/>
                            </div>
                        </div>
                    </fieldset>
                </g:form>
