      ...
      <div class="modal-body">
          <g:form class="form col-md-12 center-block" controller="user">
            <div class="form-group">
              <g:textField name="userName" value="User Name" onfocus="clearContents(this);" class="form-control input-lg"/>
            </div>
             <div class="form-group">
            ...
            <div class="form-group">
              <g:actionSubmit value="Register" action="save" class="btn btn-primary btn-lg btn-block"/>
            </div>
          </g:form>
      </div>
